...
### [references/team-rules.md](./references/team-rules.md)
...
### [references/finding-format.example.json](./references/finding-format.example.json)
...
gitlab-mr-review/scripts/list_mrs.sh 648
gitlab-mr-review/scripts/fetch_mr_details.sh 648 8
gitlab-mr-review/scripts/fetch_mr_changes.sh 648 8
gitlab-mr-review/scripts/fetch_mr_discussions.sh 648 8
```
...
gitlab-mr-review/scripts/generate_review_markdown_from_findings.sh 648 8 ./findings-648-8.json ./review-648-8.md
POST_REVIEW=true gitlab-mr-review/scripts/post_inline_review_comments.sh 648 8 ./findings-648-8.json
```
...
```bash
gitlab-mr-review/scripts/write_mr_review_markdown.sh 648 8 ./review-648-8.md
gitlab-mr-review/scripts/write_summary_markdown.sh 648 ./summary-648.md
```

실제로 저장되면 기본적으로 아래 경로에 파일이 생긴다.

```text
~/dev/gitlab-review-reports/project-648/<timestamp>-mr-8.md
~/dev/gitlab-review-reports/project-648/<timestamp>-summary.md
```
...
gitlab-mr-review/scripts/list_mrs.sh 648
gitlab-mr-review/scripts/fetch_mr_details.sh 648 8 > /tmp/mr-648-8-details.json
gitlab-mr-review/scripts/fetch_mr_changes.sh 648 8 > /tmp/mr-648-8-changes.json
gitlab-mr-review/scripts/fetch_mr_discussions.sh 648 8 > /tmp/mr-648-8-discussions.json
gitlab-mr-review/scripts/generate_review_markdown_from_findings.sh 648 8 ./findings-648-8.json ./review-648-8.md
POST_REVIEW=true gitlab-mr-review/scripts/post_inline_review_comments.sh 648 8 ./findings-648-8.json
gitlab-mr-review/scripts/write_mr_review_markdown.sh 648 8 ./review-648-8.md
gitlab-mr-review/scripts/write_summary_markdown.sh 648 ./summary-648.md
...
```text
~/.codex/automations/gitlab-mr-review-648/automation.toml
```
...
prompt = "프로젝트 648의 open merge request를 조회하고, 변경점과 파이프라인 상태를 검토해 structured review draft를 작성한다. 리뷰 기준은 [$gitlab-mr-review](~/.codex/skills/gitlab-mr-review/SKILL.md)를 따른다. 결과는 채팅 응답과 markdown 저장을 함께 수행한다. blocking issue, non-blocking suggestion, open question을 구분하고, 기존 discussion과 중복되는 지적은 줄인다. blocking issue가 0건이어도 의미 있는 P3, P4, open question은 적극적으로 finding으로 남기고, 라인 단위로 특정 가능하면 실제 리뷰 코멘트 등록 대상에 포함한다."
status = "PAUSED"
...
### [list_mrs.sh](./scripts/list_mrs.sh)
...
### [fetch_mr_details.sh](./scripts/fetch_mr_details.sh)
...
### [fetch_mr_changes.sh](./scripts/fetch_mr_changes.sh)
...
### [fetch_mr_discussions.sh](./scripts/fetch_mr_discussions.sh)
...
### [generate_review_markdown_from_findings.sh](./scripts/generate_review_markdown_from_findings.sh)
...
### [write_mr_review_markdown.sh](./scripts/write_mr_review_markdown.sh)
...
### [write_summary_markdown.sh](./scripts/write_summary_markdown.sh)
...
### [post_inline_review_comments.sh](./scripts/post_inline_review_comments.sh)
...
### [post_review_comment.sh](./scripts/post_review_comment.sh)
